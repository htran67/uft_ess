/***************************************************************
    ...
    *  loss of information.
    *          
    *  To edit the test, open the file ‘APIParam.st’ 
    *  in HP Service Test.
     ***************************************************************/
    ...
    {    
        ...
        internal void InitializeComponent()
        {
            ...
            string xmlDataFetchActivity9Params = @"<Arguments><QueryParametersContainer><QueryParameter><Name>Id</Name><Value>41b813ce-16b5-4186-8094-9d9e32102f54</Value></QueryParameter><QueryParameter><Name>QueryName</Name><Value>FData</Value></QueryParameter><QueryParameter><Name>IsEmbedded</Name><Value>True</Value></QueryParameter><QueryParameter><Name>Externalized</Name><Value>False</Value></QueryParameter><QueryParameter><Name>GroupText</Name><Value></Value></QueryParameter><QueryParameter><Name>TableStructure</Name><Value>From_ct,String,|To_ct,String,</Value></QueryParameter><QueryParameter><Name>TableContents</Name><Value>London|Sydney^Zurich|Sydney^Paris|Seattle</Value></QueryParameter></QueryParametersContainer></Arguments>";
            ...
            _flow.dataSourceNameToDataSource.Add("FData", _flow.DataFetchActivity9);
            ...
            _flow.Loop2.ConditionAsString = @"For each item in {DataSource.FData}";
            ...
            VTDPropertyInfoBase pi40 = new VTDPropertyInfoBase("OutTable");
            VTDBaseGetter binding_getter21 = new VTDObjectGetter(pi40);
            VTDPropertyInfoBase pi41 = new VTDPropertyInfoBase("Data");
            VTDBaseSetter binding_setter20 = new VTDObjectSetter(pi41);
            binding_setter20 = new StringFormaterDecorator(binding_setter20,"{Step.DataFetchActivity9.OutTable}");
            bind_dir20 = new BindDirection(_flow.DataFetchActivity9,binding_getter21,binding_setter20,BindTargetType.ToInProperty);
            _flow.DataExporterActivity11.InDirections.Add(bind_dir20);
            ...
            VTDPropertyInfoBase pi42 = new VTDPropertyInfoBase("OutTable");
            VTDBaseGetter binding_getter22 = new VTDObjectGetter(pi42);
            VTDPropertyInfoBase pi43 = new VTDPropertyInfoBase("Data");
            VTDBaseSetter binding_setter21 = new VTDObjectSetter(pi43);
            binding_setter21 = new StringFormaterDecorator(binding_setter21,"{Step.DataFetchActivity9.OutTable}");
            bind_dir21 = new BindDirection(_flow.DataFetchActivity9,binding_getter22,binding_setter21,BindTargetType.ToInProperty);
            _flow.DataDisconnectActivity10.InDirections.Add(bind_dir21);
            this.Activities.Add (_flow.DataDisconnectActivity10);
            this.DataCursorActivity13.Comment = @"";
            this.DataCursorActivity13.IconPath = @"";
            VTDPropertyInfoBase pi44 = new VTDPropertyInfoBase("OutTable");
            VTDBaseGetter binding_getter23 = new VTDObjectGetter(pi44);
            VTDPropertyInfoBase pi45 = new VTDPropertyInfoBase("InTable");
            VTDBaseSetter binding_setter22 = new VTDObjectSetter(pi45);
            binding_setter22 = new StringFormaterDecorator(binding_setter22,"{Step.DataFetchActivity9.OutTable}");
            bind_dir22 = new BindDirection(_flow.DataFetchActivity9,binding_getter23,binding_setter22,BindTargetType.ToInProperty);
            this.DataCursorActivity13.InDirections.Add(bind_dir22);
...
@"<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/""><Body><GetFlights xmlns=""HP.SOAQ.SampleApp""><DepartureCity>{DataSource.FData.From_ct}</DepartureCity><ArrivalCity>{DataSource.FData.To_ct}</ArrivalCity><FlightDate>2020-06-27T00:00:00-07:00</FlightDate></GetFlights></Body></Envelope>");
            ...
            VTDPropertyInfoBase pi46 = new VTDPropertyInfoBase("From_ct");
            VTDBaseGetter binding_getter24 = new VTDObjectGetter(pi46);
            VTDPropertyInfoBase pi47 = new VTDPropertyInfoBase("InputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='GetFlights'][1]/*[local-name(.)='DepartureCity'][1]");
            VTDBaseSetter binding_setter23 = new VTDXPathSetter(pi47,XmlTypeCode.String);
            binding_setter23 = new StringFormaterDecorator(binding_setter23,"{DataSource.FData.From_ct}");
            bind_dir23 = new BindDirection(this.DataCursorActivity13,binding_getter24,binding_setter23,BindTargetType.ToInProperty);
            _flow.StServiceCallActivity5.InDirections.Add(bind_dir23);
            VTDPropertyInfoBase pi48 = new VTDPropertyInfoBase("To_ct");
            VTDBaseGetter binding_getter25 = new VTDObjectGetter(pi48);
            VTDPropertyInfoBase pi49 = new VTDPropertyInfoBase("InputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='GetFlights'][1]/*[local-name(.)='ArrivalCity'][1]");
            VTDBaseSetter binding_setter24 = new VTDXPathSetter(pi49,XmlTypeCode.String);
            binding_setter24 = new StringFormaterDecorator(binding_setter24,"{DataSource.FData.To_ct}");
            bind_dir24 = new BindDirection(this.DataCursorActivity13,binding_getter25,binding_setter24,BindTargetType.ToInProperty);
...
@"<OutputAttachments />");
            ...
            VTDPropertyInfoBase pi50 = new VTDPropertyInfoBase("OutputEnvelope","count(/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='GetFlightsResponse'][1]/*[local-name(.)='GetFlightsResult'][1]/*[local-name(.)='Flight'])");
            VTDBaseGetter binding_getter26 = new VTDXPathGetter(pi50);
            VTDPropertyInfoBase pi51 = new VTDPropertyInfoBase("NumberOfIterations");
            VTDBaseSetter binding_setter25 = new VTDObjectSetter(pi51);
            bind_dir25 = new BindDirection(_flow.StServiceCallActivity5,binding_getter26,binding_setter25,BindTargetType.ToInProperty);
            _flow.Loop6.InDirections.Add(bind_dir25);
...
@"<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/"" xmlns:p1=""http://www.w3.org/2001/XMLSchema-instance""><Body><CreateFlightOrder xmlns=""HP.SOAQ.SampleApp""><FlightOrder><Class>Business</Class><CustomerName>Huy</CustomerName><DepartureDate>{Step.InputProperties.StServiceCallActivity5.Body.GetFlights.FlightDate}</DepartureDate><FlightNumber>{Step.OutputProperties.StServiceCallActivity5.Body.GetFlightsResponse.GetFlightsResult.Flight[{Step.OutputProperties.Loop6.CurrentIterationNumber}].FlightNumber}</FlightNumber><NumberOfTickets>1</NumberOfTickets></FlightOrder></CreateFlightOrder></Body></Envelope>");
            ...
            VTDPropertyInfoBase pi52 = new VTDPropertyInfoBase("CurrentIterationNumber");
            ...
            VTDBaseGetter binding_getter28 = new VTDXPathGetter(pi53,XmlTypeCode.Int);
            binding_getter28 = new XPathGetterDecorator(binding_getter28,"{Array0}",binding_getter27,_flow.Loop6);
            ...
            VTDBaseSetter binding_setter26 = new VTDXPathSetter(pi54,XmlTypeCode.Int);
            bind_dir26 = new BindDirection(_flow.StServiceCallActivity5,binding_getter28,binding_setter26,BindTargetType.ToInProperty);
            _flow.StServiceCallActivity4.InDirections.Add(bind_dir26);
            VTDPropertyInfoBase pi55 = new VTDPropertyInfoBase("InputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='GetFlights'][1]/*[local-name(.)='FlightDate'][1]");
            VTDBaseGetter binding_getter29 = new VTDXPathGetter(pi55,XmlTypeCode.DateTime);
            VTDPropertyInfoBase pi56 = new VTDPropertyInfoBase("InputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='CreateFlightOrder'][1]/*[local-name(.)='FlightOrder'][1]/*[local-name(.)='DepartureDate'][1]");
            VTDBaseSetter binding_setter27 = new VTDXPathSetter(pi56,XmlTypeCode.DateTime);
            bind_dir27 = new BindDirection(_flow.StServiceCallActivity5,binding_getter29,binding_setter27,BindTargetType.ToInProperty);
